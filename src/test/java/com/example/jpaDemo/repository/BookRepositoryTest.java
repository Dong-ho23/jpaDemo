...
import com.example.jpaDemo.repository.dto.BookStatus;
...
//        book.setPublisherId(1L);
    ...
    void bookRelationTest() {
        ...
        User user = userRepository.findByEmail("endgh43@gmail.com");
    ...
    void bookCascadeTest() {
        ...
        book1.getPublisher().setName("endgh40");
...
//        bookRepository.findAllCustom().forEach(System.out::println);
    ...
    private User givenUser() {
        return userRepository.findByEmail("endgh43@gmail.com");
    }
